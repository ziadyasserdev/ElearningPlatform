...
{
    public class UpdateCourseThumbnailCommandHandler:IRequestHandler<UpdateCourseThumbnailCommand, Result<string>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly ICurrentUserService currentUserService;
        private readonly IFileService fileService;

        public UpdateCourseThumbnailCommandHandler(IUnitOfWork unitOfWork,
        ...
        public async Task<Result<string>> Handle(UpdateCourseThumbnailCommand request, CancellationToken cancellationToken)
        {
            ...
            if (course.ThumbnailUrl is  null)
                return Result<string>.Failure(ResultStatus.Failure, "Course does not have a thumbnail to update. Please use the upload endpoint to add a thumbnail first.");
            ...
            return Result<string>.Success("Thumbnail updated successfully");
