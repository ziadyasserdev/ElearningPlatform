...
namespace ElearningPlatform.Application.Features.Videos.Commands.UploadThumbnail
{
    public class UploadThumbnailCommandHandler : IRequestHandler<UploadThumbnailCommand, Result<int>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly ICurrentUserService currentUserService;
        private readonly IFileService fileService;

        public UploadThumbnailCommandHandler(IUnitOfWork unitOfWork
        ...
        public async Task<Result<int>> Handle(UploadThumbnailCommand request, CancellationToken cancellationToken)
        {
            ...
            return Result<int>.Success(video.Id, "Thumbnail uploaded successfully");
        }
    }
}
