...
{
    /// <inheritdoc />
    public partial class gow : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Videos_AspNetUsers_UploadedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreAwarded = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoProgresses", x => new { x.UserId, x.VideoId });
                    table.ForeignKey(
